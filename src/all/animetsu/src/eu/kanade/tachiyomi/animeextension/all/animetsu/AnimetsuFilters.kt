...
object AnimetsuFilters {
    ...
    class GenreFilter : AnimeFilter.Group<GenreCheckBox>("Genres", GENRES.map { GenreCheckBox(it.first, it.second) }) {
        ...
        companion object {
            private val GENRES = listOf(
                ...
                "Horror" to "Horror", "Mahou Shoujo" to "Mahou Shoujo", "Mecha" to "Mecha",
                "Music" to "Music", "Mystery" to "Mystery", "Psychological" to "Psychological",
                "Romance" to "Romance", "Sci-Fi" to "Sci-Fi", "Slice of Life" to "Slice of Life",
                "Sports" to "Sports", "Supernatural" to "Supernatural", "Thriller" to "Thriller",
            )
        }
    }
    ...
    class FormatFilter : AnimeFilter.Select<String>("Format", FORMAT_ENTRIES.toTypedArray(), 0) {
        ...
        companion object {
            private val FORMAT_ENTRIES = listOf("Any", "Movie", "TV", "TV Short", "Special", "OVA", "ONA")
            private val FORMAT_VALUES = listOf("", "MOVIE", "TV", "TV_SHORT", "SPECIAL", "OVA", "ONA")
        }
    }
    ...
    class SortFilter : AnimeFilter.Select<String>("Sort By", SORT_ENTRIES.toTypedArray(), 0) {
        ...
        companion object {
            private val SORT_ENTRIES = listOf("Popularity", "Average Score", "Release Date", "Favourites", "Trending")
            private val SORT_VALUES = listOf("popularity", "average_score", "date_desc", "favourites", "trending")
        }
    }
    ...
    class TagFilter : AnimeFilter.Group<TagCheckBox>("Tags", TAGS.map { TagCheckBox(it, it) }) {
        ...
        companion object {
            private val TAGS = listOf(
                ...
                "Hikikomori", "Ice Skating", "Historical", "Idol", "Isekai", "Iyashikei", "Josei",
                "Kaiju", "Karuta", "Kemonomimi", "Kids", "Love Triangle", "Mafia", "Magic",
                "Mahjong", "Male Protagonist", "Maids", "Martial Arts", "Memory Manipulation",
                "Meta", "Monster Girl", "Military", "Mopeds", "Motorcycles", "Musical", "Mythology",
                "Nekomimi", "Ninja", "No Dialogue", "Noir", "Nudity", "Otaku Culture", "Outdoor",
                "Parody", "Philosophy", "Pirates", "Photography", "Poker", "Police", "Politics",
                "Post-Apocalyptic", "Primarily Adult Cast", "Primarily Female Cast", "Primarily Male Cast",
                "Puppetry", "Real Robot", "Reincarnation", "Rehabilitation", "Revenge",
                "Reverse Harem", "Rugby", "Robots", "Rural", "Samurai", "Satire", "School",
                "School Club", "Seinen", "Ships", "Shogi", "Shoujo", "Shoujo Ai", "Shounen",
                "Shounen Ai", "Slapstick", "Slavery", "Space", "Space Opera", "Steampunk",
                "Stop Motion", "Super Power", "Super Robot", "Superhero", "Surreal Comedy",
                "Survival", "Swimming", "Swordplay", "Table Tennis", "Tanks", "Teacher",
                "Terrorism", "Tennis", "Time Manipulation", "Time Skip", "Tragedy", "Trains",
                "Triads", "Tsundere", "Urban Fantasy", "Vampire", "Video Games", "Virtual World",
                "Volleyball", "War", "Witch", "Work", "Wrestling", "Writing", "Wuxia", "Yakuza",
                "Yandere", "Youkai", "Zombie",
            )
        }
    }
    ...
    class SourceFilter : AnimeFilter.Select<String>("Source Material", SOURCE_ENTRIES.toTypedArray(), 0) {
        ...
        companion object {
            private val SOURCE_ENTRIES = listOf(
                "Any", "Novel", "Light Novel", "Web Novel", "Comic",
                "Doujinshi", "Live Action", "Video Game", "Game",
                "Multimedia Project", "Picture Book", "Other",
            )
            private val SOURCE_VALUES = listOf(
                "", "NOVEL", "LIGHT_NOVEL", "WEB_NOVEL", "COMIC",
                "DOUJINSHI", "LIVE_ACTION", "VIDEO_GAME", "GAME",
                "MULTIMEDIA_PROJECT", "PICTURE_BOOK", "OTHER",
            )
        }
    }
